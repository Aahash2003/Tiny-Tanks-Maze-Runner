...
private void InitializeScoreUI()
{
    foreach (var tank in m_Tanks)
    {
        ...
        // Assign the text to display the initial score
        scoreText.text = $"Player {tank.m_PlayerNumber}: 0";
       ...
       private TankManager GetRoundWinner()
{
    ...
    return null;
        ...
        {
            message += $"\nFastest Round: {m_FastestRound:F2} seconds!";
        }
    ...
    Debug.Log($"Round Winner set: Player {m_RoundWinner.m_PlayerNumber}");
        ...
        public void UpdateScoreUI()
        {
            foreach (var tank in m_Tanks)
            {
                ...
                {
                    tank.m_ScoreText.text = $"Player {tank.m_PlayerNumber}: {tank.m_Score}";
                }
            }
        }
